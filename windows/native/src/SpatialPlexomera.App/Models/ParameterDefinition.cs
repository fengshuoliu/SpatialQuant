...
public static class ParameterCatalog
{
    ...
    [
        new("r_voronoi_um", "Voronoi radius", "Voronoi 半径", 3, 0, 300, 1, "µm",
        ...
        new("r_buffer_um", "Buffer radius", "缓冲半径", 2, 0, 300, 1, "µm",
        ...
        new("r_vote_um", "Vote radius", "投票半径", 3, 0, 300, 1, "µm",
        ...
        new("tophat_r_um", "Top-hat radius", "顶帽半径", 1, 0, 150, 1, "µm",
        ...
        new("gauss_sigma_um", "Gaussian sigma", "高斯标准差", 0.5, 0, 75, 0.5, "µm",
        ...
        new("ambiguous_min_probability", "Minimum winning probability", "最低获胜概率", 0.60, 0, 1, 0.01, "",
        ...
        new("ambiguous_min_gap", "Minimum probability gap", "最小概率差", 0.10, 0, 1, 0.01, "",
