...
struct ContentView: View {
    ...
    var body: some View {
        NavigationSplitView {
            ...
            ZStack {
                SpatialPlexomeraCanvasBackground()
        ...
        .spatialPlexomeraWindowMaterial()
        .toolbar {
            ToolbarItemGroup {
                Button {
    ...
    private var glassContainedDetailContent: some View {
        if #available(macOS 26.0, *) {
            GlassEffectContainer(spacing: SpatialPlexomeraDesign.sectionSpacing) {
                styledDetailContent
            }
        } else {
            styledDetailContent
    ...
    var body: some View {
        HStack(spacing: 15) {
            Image(systemName: section.systemImage)
                ...
                .spatialPlexomeraGlassSurface(cornerRadius: 8, tint: Color.accentColor.opacity(0.12))
        ...
        .padding(.vertical, 17)
        .spatialPlexomeraGlassSurface(cornerRadius: 0, tint: Color.accentColor.opacity(0.035))
    }
}
