...
from spatialplexomera_analysis.models import RegionParams
from spatialplexomera_analysis.region_analysis import run_region_boundary_analysis
...
def run_smoke() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="spatialplexomera-region-registry-") as temp_dir:
