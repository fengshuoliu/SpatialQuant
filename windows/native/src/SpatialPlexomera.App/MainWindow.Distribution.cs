...
public partial class MainWindow
{
    private UIElement BuildDistributionView()
    {
        ...
        boundaryStack.Children.Add(CreateSupportingText(
            DistributionText(
                "Choose one saved ROI boundary. SpatialPlexomera creates equal-width distance bands on both sides and preserves the band map for review.",
                "选择一个已保存的 ROI 边界。SpatialPlexomera 会在边界两侧生成等宽距离带，并保存分带图供检查。"),
