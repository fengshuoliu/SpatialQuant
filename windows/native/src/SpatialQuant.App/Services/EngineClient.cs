...
namespace SpatialQuant.Windows.Services;
...
public sealed class EngineClient : IAsyncDisposable
{
    ...
    public async Task StartAsync(CancellationToken cancellationToken = default)
    {
        ...
        startInfo.Environment["SPATIALQUANT_CPU_WORKERS"] = cpuCount;
        startInfo.Environment["SPATIALQUANT_GPU_MODE"] = "auto";
        ...
        _process = Process.Start(startInfo) ?? throw new InvalidOperationException("Could not start the SpatialQuant analysis engine.");
    ...
    public async ValueTask DisposeAsync()
    {
        ...
        finally
        {
            ...
            var stopped = new ObjectDisposedException(nameof(EngineClient), "The analysis engine was stopped because SpatialQuant is closing.");
    ...
    private static (string Executable, string Arguments, string WorkingDirectory) ResolveLaunchCommand()
    {
        ...
        {
            Path.Combine(baseDirectory, "engine", "SpatialQuantEngine.exe"),
            Path.Combine(baseDirectory, "SpatialQuantEngine.exe"),
        };
        ...
        var configuredEngine = Environment.GetEnvironmentVariable("SPATIALQUANT_ENGINE_PATH");
        ...
        throw new FileNotFoundException("SpatialQuantEngine.exe or windows/backend/native_engine.py was not found.");
    }
}
