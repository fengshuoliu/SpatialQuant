...
struct StatusBarView: View {
    ...
    var body: some View {
        ...
        .padding(.vertical, 9)
        .spatialPlexomeraGlassSurface(cornerRadius: 7, tint: statusColor.opacity(0.06))
    }
                ...
                ZoomableImageView(image: image, backgroundColor: backgroundColor)
                    ...
                    .overlay {
                        RoundedRectangle(cornerRadius: 8)
                            .stroke(SpatialPlexomeraDesign.panelBorder, lineWidth: 1)
                    }
            } else {
                EmptyStateView(
                    systemImage: "photo",
